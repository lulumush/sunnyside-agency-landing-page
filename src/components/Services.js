...
function Services() {
  return (
    <section id="services" className='grid grid-cols-1 auto-rows-fr md:grid-cols-2'>
        <div className='bg-servicesDesignMobile bg-cover bg-no-repeat bg-top text-center text-darkCyan pt-[380px] pb-10 px-4 smd:bg-servicesDesignDesktop'>
        ...
        <div className='bg-servicesPhotographyMobile bg-cover bg-no-repeat bg-top text-center text-darkCyan pt-[380px] pb-10 px-4 smd:bg-servicesPhotographyDesktop'>
